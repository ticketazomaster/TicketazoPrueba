...
const Pages = (() => {
  const reviewsCache = (function() {
    try { return JSON.parse(localStorage.getItem('ticketazo.reviews')) || {}; }
    catch(e) { return {}; }
  })();

  function _saveReviews() {
    try { localStorage.setItem('ticketazo.reviews', JSON.stringify(reviewsCache)); } catch(e) {}
  }
  let pendingRating = 0;
  let currentEventId = '';
