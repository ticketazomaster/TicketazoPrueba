...
window.App = (() => {
  ...
  function navigate(page) {
    ...
    // Actualizar la visibilidad del botón "Volver al inicio" tras cada cambio de página
    updateNav();
  }
  ...
  function updateNav() {
    ...
    // "Volver al inicio" solo tiene sentido fuera del home
    const notHome = logged && _current !== 'home';
    notHome ? show('btn-home-nav') : hide('btn-home-nav');
        ...
        <div>
          ...
          <div class="footer-contact-item">
            ...
            <div><div class="footer-contact-label">Correo</div>
              <div class="footer-contact-val"><a href="mailto:ticketazo.master@gmail.com">ticketazo.master@gmail.com"</a></div></div>
          </div>
          <div class="footer-contact-item">
            <div class="footer-contact-icon" style="color:var(--color-blue)">${Icons.phone}</div>
            <div><div class="footer-contact-label">Teléfono</div>
              <div class="footer-contact-val"><a href="tel:+52 1 667 196 4575">+52 1 667 196 4575</a></div>
