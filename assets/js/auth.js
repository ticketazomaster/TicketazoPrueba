  ...
  (async () => {
    try {
      ...
      if (!_sb && window.supabase?.createClient) {
        ...
        _sb = createClient('https://urumaghjardjgdveblxa.supabase.co', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVydW1hZ2hqYXJkamdkdmVibHhhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzM3ODg3MjAsImV4cCI6MjA4OTM2NDcyMH0.qNfIZu-8lQQKUDzEbwJsF4y3cIthx2nDXwHkHCnaZcI');
      }
